...
var wileyjournals = {
  ...
  "Advanced Synthesis &amp; Catalysis":
    "10.1002/(ISSN)(1615-4169,1521-3897,1521-3897,1521-3897)",
  ...
  "Zeitschrift f&uuml;r anorganische und allgemeine Chemie":
    "10.1002/(ISSN)1521-3749",
...
function openWiley(t, v, p, ambsearch) {
  ...
  postQuery("http://onlinelibrary.wiley.com/search/citation/results", {
    volume: v,
    page: p,
    publicationDoi: wileyjournals[t],
  });
}
