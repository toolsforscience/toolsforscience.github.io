...
function initializeOthers() {
  ...
  otherjournals["Science"] = function (v, p) {
    location.href =
      "http://www.sciencemag.org/cgi/search?volume=" +
      v +
      "&firstpage=" +
      p +
      "&search_citation-search.x=53&search_citation-search.y=11&search_citation-search=search";
  };

  //PNAS
  otherjournals["PNAS"] = function (v, p) {
    openURL(
      "http://www.pnas.org/search?submit=yes&submit=Submit&volume=" +
        v +
        "&firstpage=" +
        p
    );
    openURL(
      "http://www.pnas.org/search?submit=yes&submit=Submit&pubdate_year=&volume=" +
        v +
        "&firstpage=" +
        p +
        "&doi=&author1=&author2=&title=&andorexacttitle=and&titleabstract=&andorexacttitleabs=and&fulltext=&andorexactfulltext=and&fmonth=&fyear=&tmonth=&tyear=&tocsectionid=all&format=standard&hits=10&sortspec=relevance&submit=yes"
    );
  };
  ...
  otherjournals["J. Biol. Chem."] = function (v, p) {
    openURL(
      "http://www.jbc.org/search?author1=&fulltext=&pubdate_year=&volume=" +
        v +
        "&firstpage=" +
        p +
        "&submit=yes"
  ...
  otherjournals["PLoS ONE"] = function (v, p) {
    postQuery("http://www.plosbiology.org/search/findAnArticleSearch.action", {
      volume: v,
      eLocationId: p,
  ...
  otherjournals["PLoS Collections"] = function (v, p) {
    postQuery("http://www.plosbiology.org/search/findAnArticleSearch.action", {
      volume: v,
      eLocationId: p,
      filterJournals: "PLoSCollections",
    });
  };
  ...
  otherjournals["Bulletin of the Chemical Society of Japan"] = function (v, p) {
    getQuery("http://www.jstage.jst.go.jp/jump/bcsj/-char/ja", {
      vol: v,
      startpage: p,
    });
  };
  otherjournals["Chemistry Letters"] = function (v, p) {
    getQuery("http://www.is.csj.jp/php/navi.php", {
      year: v,
      page: p,
      journal: "cl",
    });
  ...
  otherjournals["Organic Syntheses"] = function (v, p) {
    getQuery("http://www.orgsyn.org/orgsyn/default.asp", {
      dbname: "orgsyn",
      dataaction: "search",
      metadata_directive: "blind_gui",
      formgroup: "quick_form_group",
      "Preps.AnnVol": v,
      "Preps.AnnPage": p,
    });
  };
  ...
  otherjournals["The Journal of Immunology"] = function (v, p) {
    openURL(
      "http://www.jimmunol.org/search?" +
        "submit=yes&submit=Submit&pubdate_year=&volume=" +
        v +
        "&firstpage=" +
        p +
  ...
  otherjournals["The Journal of Experimental Medicine"] = function (v, p) {
    openURL(
      "http://jem.rupress.org/search?submit=yes&submit=Submit&pubdate_year=&volume=" +
        v +
        "&firstpage=" +
        p +
        "&doi=&author1=&author2=&title=&andorexacttitle=and&titleabstract=&andorexacttitleabs=and&fulltext=&andorexactfulltext=and&fmonth=&fyear=&tmonth=&tyear=&tocsectionid=all&format=standard&hits=10&sortspec=date&submit=yes"
    );
  };

  otherjournals["The Journal of Cell Biology"] = function (v, p) {
    openURL(
      "http://jcb.rupress.org/search?submit=yes&submit=Submit&pubdate_year=&volume=" +
        v +
        "&firstpage=" +
        p +
        "&doi=&author1=&author2=&title=&andorexacttitle=and&titleabstract=&andorexacttitleabs=and&fulltext=&andorexactfulltext=and&fmonth=&fyear=&tmonth=&tyear=&tocsectionid=all&format=standard&hits=10&sortspec=date&submit=yes"
  ...
  otherjournals["The Journal of General Physiology"] = function (v, p) {
    openURL(
      "http://jgp.rupress.org/search?submit=yes&submit=Submit&pubdate_year=&volume=" +
        v +
        "&firstpage=" +
        p +
        "&doi=&author1=&author2=&title=&andorexacttitle=and&titleabstract=&andorexacttitleabs=and&fulltext=&andorexactfulltext=and&fmonth=&fyear=&tmonth=&tyear=&tocsectionid=all&format=standard&hits=10&sortspec=date&submit=yes"
  ...
  otherjournals["Applied Physics Express"] = function (v, p) {
    openURL(
      "http://apex.jsap.jp/cgi-bin/getarticle?magazine=APEX&volume=" +
        v +
        "&page=" +
        p
    );
  ...
  otherjournals["Japanese Journal of Applied Physics"] = function (v, p) {
    openURL(
      "http://jjap.jsap.jp/cgi-bin/getarticle?magazine=JJAP&volume=" +
        v +
        "&page=" +
        p
    );
  ...
  otherjournals["Genes & Development"] = function (v, p) {
    openURL(
      "http://genesdev.cshlp.org/search?submit=yes&submit=Submit&pubdate_year=&volume=" +
        v +
        "&firstpage=" +
        p +
        "&doi=&author1=&author2=&title=&andorexacttitle=and&titleabstract=&andorexacttitleabs=and&fulltext=&andorexactfulltext=and&fmonth=&fyear=&tmonth=&tyear=&format=standard&hits=10&sortspec=relevance&submit=yes"
    );
  };
  otherjournals["RNA"] = function (v, p) {
    openURL(
      "http://rnajournal.cshlp.org/search?submit=yes&submit=Submit&pubdate_year=&volume=" +
        v +
        "&firstpage=" +
        p +
        "&doi=&author1=&author2=&title=&andorexacttitle=and&titleabstract=&andorexacttitleabs=and&fulltext=&andorexactfulltext=and&fmonth=&fyear=&tmonth=&tyear=&format=standard&hits=10&sortspec=relevance&submit=yes"
